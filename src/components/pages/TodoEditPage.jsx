...
export const TodoEditPage = memo(() => {
	...
	const [isInputTitleIndicateFlag, setIsInputTitleIndicateFlag] = useState(false);
	const [isInputDetailIndicateFlag, setIsInputDetailIndicateFlag] = useState(false);
		...
		<>
			...
			<TodoDetailsContainer>
				...
				{isInputTitleIndicateFlag ? (
					<TextEditForm id={fetchId} buttonName={"変更する"} placeholder={"変更を入力してください"} />
				) : (
					""
				)}
